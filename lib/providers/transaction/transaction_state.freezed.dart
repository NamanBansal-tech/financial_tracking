...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ETransactionState eTransactionState,  List<TransactionModel> transactions,  List<TransactionModel> graphTransactions,  List<TransactionModel> calenderMonthtransactions,  bool isIncomeAddInBudget,  PageMeta pageMeta,  String? message,  DateTime? fromLineChartDate,  DateTime? toLineChartDate,  DateTime? selectedCalenderMonth,  TransactionType? selectedTransactionType,  int? selectedCategoryId,  DateTime? selectedDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionState() when $default != null:
return $default(_that.eTransactionState,_that.transactions,_that.graphTransactions,_that.calenderMonthtransactions,_that.isIncomeAddInBudget,_that.pageMeta,_that.message,_that.fromLineChartDate,_that.toLineChartDate,_that.selectedCalenderMonth,_that.selectedTransactionType,_that.selectedCategoryId,_that.selectedDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ETransactionState eTransactionState,  List<TransactionModel> transactions,  List<TransactionModel> graphTransactions,  List<TransactionModel> calenderMonthtransactions,  bool isIncomeAddInBudget,  PageMeta pageMeta,  String? message,  DateTime? fromLineChartDate,  DateTime? toLineChartDate,  DateTime? selectedCalenderMonth,  TransactionType? selectedTransactionType,  int? selectedCategoryId,  DateTime? selectedDate)  $default,) {final _that = this;
switch (_that) {
case _TransactionState():
return $default(_that.eTransactionState,_that.transactions,_that.graphTransactions,_that.calenderMonthtransactions,_that.isIncomeAddInBudget,_that.pageMeta,_that.message,_that.fromLineChartDate,_that.toLineChartDate,_that.selectedCalenderMonth,_that.selectedTransactionType,_that.selectedCategoryId,_that.selectedDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ETransactionState eTransactionState,  List<TransactionModel> transactions,  List<TransactionModel> graphTransactions,  List<TransactionModel> calenderMonthtransactions,  bool isIncomeAddInBudget,  PageMeta pageMeta,  String? message,  DateTime? fromLineChartDate,  DateTime? toLineChartDate,  DateTime? selectedCalenderMonth,  TransactionType? selectedTransactionType,  int? selectedCategoryId,  DateTime? selectedDate)?  $default,) {final _that = this;
switch (_that) {
case _TransactionState() when $default != null:
return $default(_that.eTransactionState,_that.transactions,_that.graphTransactions,_that.calenderMonthtransactions,_that.isIncomeAddInBudget,_that.pageMeta,_that.message,_that.fromLineChartDate,_that.toLineChartDate,_that.selectedCalenderMonth,_that.selectedTransactionType,_that.selectedCategoryId,_that.selectedDate);case _:
  return null;
