...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( dynamic amount,  int? categoryId,  String? date,  String? notes,  int? type,  int? id)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionModel() when $default != null:
return $default(_that.amount,_that.categoryId,_that.date,_that.notes,_that.type,_that.id);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( dynamic amount,  int? categoryId,  String? date,  String? notes,  int? type,  int? id)  $default,) {final _that = this;
switch (_that) {
case _TransactionModel():
return $default(_that.amount,_that.categoryId,_that.date,_that.notes,_that.type,_that.id);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( dynamic amount,  int? categoryId,  String? date,  String? notes,  int? type,  int? id)?  $default,) {final _that = this;
switch (_that) {
case _TransactionModel() when $default != null:
return $default(_that.amount,_that.categoryId,_that.date,_that.notes,_that.type,_that.id);case _:
  return null;
