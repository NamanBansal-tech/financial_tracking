...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,totalExpense,budgetAmount,startDate,endDate);

@override
String toString() {
  return 'BudgetModel(id: $id, name: $name, totalExpense: $totalExpense, budgetAmount: $budgetAmount, startDate: $startDate, endDate: $endDate)';
}
...
/// Create a copy of BudgetModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? name = freezed,Object? totalExpense = freezed,Object? budgetAmount = freezed,Object? startDate = freezed,Object? endDate = freezed,}) {
...
class _BudgetModel implements BudgetModel {
   _BudgetModel({this.id, this.name, this.totalExpense, this.budgetAmount, this.startDate, this.endDate});
...
/// Create a copy of BudgetModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? name = freezed,Object? totalExpense = freezed,Object? budgetAmount = freezed,Object? startDate = freezed,Object? endDate = freezed,}) {
